    ...
    try:
        ...
        while True:
            ...
            for row in orders.to_dict("records"):
                ...
                Label(root,text='Avg',width=8,bg="cornsilk3",fg="black",font=("Arial Black",10)).place(x=260,y=250)
                Label(root,text='LTP',width=10,bg="cornsilk3",fg="black",font=("Arial Black",10)).place(x=330,y=250)
                Label(root,text='QTY',width=10,bg="cornsilk3",fg="black",font=("Arial Black",10)).place(x=410,y=250)
...
# CE BUY button
CE_BUY_Btn1 = Button(root, text='Buy',font=("Helvatical bold",10),width=4,fg="white",bg="black",command=lambda:startThread(2))
CE_BUY_Btn1.place(x=500, y=150)
# PE BUY button
PE_BUY_Btn1 = Button(root, text='Buy',width=4,font=("Helvatical bold",10),fg="white",bg="black",command=lambda:startThread(4))
